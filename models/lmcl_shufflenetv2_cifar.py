...
def lmcl_ShuffleNetV2_05x_cifar(num_classes, number_net):
    return ShuffleNetV2_n(net_size=0.5, num_classes=num_classes, number_net=number_net)


def lmcl_ShuffleNetV2_1x_cifar(num_classes, number_net):
    return ShuffleNetV2_n(net_size=1, num_classes=num_classes, number_net=number_net)


if __name__ == '__main__':
    net = lmcl_ShuffleNetV2_05x_cifar(num_classes=100, number_net=4)
